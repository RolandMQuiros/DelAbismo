...
public:
    ...
    /**
     * Returns a reference to this Animation's texture
     * @return
     *   this Animation's texture
     */
    TexturePtr getTexture() const;

    /**
     * Adds a frame to the animation.
     * A frame is a subrectangle of the texture.
     * @param $frame
     *   subrectangle of this Animation's texture
     * @param $states
     *   render states
     * @param $color
     *   render color
     ...
     * Play().
     * @param $loop
     *   number of times to loop.  Negative for indefinite looping.
     */
     ...
     * @param $frame
     *   first frame of the animation played
     */
     ...
     * @param $true
     *   if no frames or texture has been set.  False, otherwise.
     */
    bool isEmpty() const;
